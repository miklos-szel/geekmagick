...
uint32_t Webserver::s_lastActivityMs = 0;

auto Webserver::markActivity() -> void { s_lastActivityMs = millis(); }

auto Webserver::lastActivityMs() -> uint32_t { return s_lastActivityMs; }
