...
- Device AP: `GeekMagic` / `$str0ngPa$$w0rd`, AP IP `192.168.4.1`
- Default API token: `my-secret-token`
- `data/gif/default.gif` plays once at boot (intro), `data/gif/default_1.gif` loops
